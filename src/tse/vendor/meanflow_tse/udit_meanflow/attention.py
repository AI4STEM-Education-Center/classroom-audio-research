"""Multi-head attention with RoPE for UDiT.

Vendored from: https://github.com/rikishimizu/MeanFlow-TSE/blob/main/models/udit_meanflow/attention.py
License: MIT (Meta Platforms, Inc.)
"""
